namespace EACV2
{
	...
	public class EACTimedEvent {
		...
		public delegate void TimedEventFireDelegate(EACTimedEvent evt);

		public event TimedEventFireDelegate OnFire;

		public EACTimedEvent(double interval) {
		...
		public EACTimedEvent(double interval, Dictionary<string, object> args)
			: this(interval) {
			this.Args = args;
		}
